...
```
![Figure caption](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Triangle_area_from_coordinates_JCB.jpg/732px-Triangle_area_from_coordinates_JCB.jpg){#fig:id `lign="middle" .image-medium}
```

Result:

![Figure](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Triangle_area_from_coordinates_JCB.jpg/732px-Triangle_area_from_coordinates_JCB.jpg){: #figid align="middle" .image-medium}
{:title="titleID"}
{: #pID}
